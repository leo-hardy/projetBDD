...
$info5 = "INSERT INTO `livres`.`livre` (`id_livre`,`titre_livre`,`genre`,`parution`,`nature`,`langue`) VALUES ('1','Le cycle des robots','science-fiction','1950','nouvelle','anglais'), ('2','La possibilite d\'une ile','sentimental','2005','roman','franc_ais'), ('3','Fondation','science-fiction','1942','roman','anglais')" ;
$conn->query($info1);
